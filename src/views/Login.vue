        ...
        <div class="card card-container">
            ...
            <form name="form" @submit.prevent="handleLogin">
                <div class="form-group">
                    ...
                    <div v-if="errors.has('email')" class="alert alert-danger" role="alert">Email is required!
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input v-model="user.password" v-validate="'required'" type="password" class="form-control"
                        name="password" />
                    <div v-if="errors.has('password')" class="alert alert-danger" role="alert">Password is required!
                    </div>
                </div>
                <div class="form-group">
        ...
        handleLogin() {
            ...
            this.$validator.validateAll().then(isValid => {
                ...
                if (this.user.email && this.user.password) {
                    //auth/login es el action de auth.module
